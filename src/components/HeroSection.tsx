...
export const HeroSection = () => {
  ...
  return (
    <section className="relative w-full h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      {/* Petal decorations */}
      <div className="absolute top-6 left-1/2 -translate-x-1/2 text-[hsl(var(--rosé-light))] opacity-60 text-2xl animate-float select-none pointer-events-none">
        ✿ ✿ ✿
      </div>
      ...
      <div className={`relative z-10 text-center px-6 max-w-3xl mx-auto transition-all duration-1000 ${loaded ? "opacity-100" : "opacity-0"}`}>
        ...
        {/* Save the date */}
        <p className="animate-fade-up-delay-1 font-body tracking-[0.25em] uppercase text-xs text-[hsl(var(--rosé-light))] mb-4">
          Save the Date
        </p>

        {/* Romantic quote */}
        <blockquote className="animate-fade-up-delay-1 font-display italic font-light text-xl md:text-2xl leading-relaxed text-white/90 mb-8 px-2">
        ...
        <h1 className="animate-fade-up-delay-2 font-display font-light text-5xl md:text-7xl text-white tracking-wide mb-3">
          Isabella <span className="text-[hsl(var(--rosé-light))] font-normal italic">&amp;</span> Rafael
        </h1>

        {/* Divider */}
        <div className="animate-fade-up-delay-3 flex items-center justify-center gap-4 mb-4">
          <div className="h-px w-16 bg-[hsl(var(--rosé-light))]/60" />
          <span className="text-[hsl(var(--rosé-light))] text-lg">✦</span>
          <div className="h-px w-16 bg-[hsl(var(--rosé-light))]/60" />
        </div>

        {/* Date */}
        <p className="animate-fade-up-delay-3 font-body text-white/80 tracking-[0.3em] text-sm uppercase mb-10">
          14 de Fevereiro de 2026 · São Paulo
        </p>
